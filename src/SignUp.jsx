...
function SignUp() {
  ...
  return (
    <div >
      <div className='justify-center flex bg-rose-300'>
        <Link to="/"><img src="public\logo.png" className="md:w-40 w-32" /></Link>
      </div>
      <div className='md:flex justify-center mb-4 bg-rose-300'>
        <form onSubmit={handleSubmit} className='md:w-3/4 flex flex-col justify-center text-center border-2 border-red-400 rounded-md m-4 items-center'>
          ...
          onBlur={handleBlur}
           ...
           required className='border-2 border-red-400 rounded m-2 font-Qwitcher text-3xl' 
          ...
          autoComplete="email" 
          required type="email" 
          className='border-2 border-red-400 rounded m-2 font-Qwitcher text-3xl' 
          placeholder='Email' />
